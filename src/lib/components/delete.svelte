...
<dialog bind:this={dialog} class="w-3/4 md:w-2/5 border border-zinc-700 rounded-lg shadow-lg bg-zinc-900 text-white/90 backdrop-blur-sm">
	<form {action} method="post" onsubmit="{submit}"  use:enhance>
		...
		<div class="flex justify-between gap-4 items-center p-4 bg-zinc-800">
			...
			<button type="submit" class="px-3 py-2 text-sm text-black/90 rounded-lg bg-zinc-100 hover:bg-zinc-200">Yes</button>
		</div>
	</form>
</dialog>